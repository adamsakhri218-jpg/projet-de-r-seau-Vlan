...
* Comprendre le fonctionnement d’un réseau local (LAN)
* Configurer les adresses IP et le masque de sous-réseau
...
* Cisco Packet Tracer / GNS3 (selon ton cas)
* Windows / Linux
...
1. Ouvrir le fichier du projet avec Cisco Packet Tracer / GNS3
2. Vérifier la configuration des équipements
